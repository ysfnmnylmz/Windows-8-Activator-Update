        ...
        for match2 in matches2:
            ...
            if len(dlist2) > 1:
                for i in Matches.objects.filter(home_team=dlist2[2]):
                    ...
                    if i.iy_over_05 >= 68 or i.iy_over_25 >= 12 or i.iy_over_15 >= 30 and i.over_05 == '0.5 Üst':
                        i.tahmin_iy05 = 'İY 0.5 Üst'
                    if i.iy_over_15 >= 30 or i.iy_over_25 >= 12 and i.over_15 == '1.5 Üst':
                        i.tahmin_iy15 = 'İY 1.5 Üst'
                    if i.iy_over_25 >= 12 or i.over_25 > 50 and i.over_25 == '2.5 Üst':
